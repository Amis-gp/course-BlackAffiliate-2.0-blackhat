...
export default function LessonPage() {
  ...
  const currentLessonId = params ? (Array.isArray(params.id) ? params.id[0] : params.id) : undefined;
  ...
  return (
    <ProtectedRoute>
      ...
      <div className="min-h-screen bg-background flex">
        ...
        <div className={`fixed lg:static inset-y-0 left-0 z-50 w-80 bg-[#0f1012] transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isMobileNavOpen ? 'translate-x-0' : '-translate-x-full'} flex flex-col`}>
